...
exports.POWER = function(number, power) {
  number = utils.parseNumber(number, true);
  power = utils.parseNumber(power, true);
...
exports.ADD = function (num1, num2) {
  ...
  num1 = utils.parseNumber(num1, true);
  num2 = utils.parseNumber(num2, true);
...
exports.DIVIDE = function (dividend, divisor) {
  ...
  dividend = utils.parseNumber(dividend, true);
  divisor = utils.parseNumber(divisor, true);
  var anyError = utils.anyError(dividend, divisor);
  if (anyError) {
    return anyError;
  }
...
exports.MULTIPLY = function (factor1, factor2) {
  ...
  factor1 = utils.parseNumber(factor1, true);
  factor2 = utils.parseNumber(factor2, true);
