...
describe('Financial', () => {
  ...
  it('DISC', () => {
    // expect(financial.DISC('01/04/2023', '01/31/2023', 99.71275, 100, 0)).to.approximately(0.383, 1e-11)
    ...
    // expect(financial.DISC('01/04/2023', '02/28/2023', 99.36300834, 100, 0)).to.approximately(0.04246611067, 1e-11)
    expect(financial.DISC('01/04/2023', '02/28/2023', 99.36300834, 100, 1)).to.approximately(0.04227308289, 1e-11)
    expect(financial.DISC('01/04/2023', '02/28/2023', 99.36300834, 100, 2)).to.approximately(0.04169399956, 1e-11)
    expect(financial.DISC('01/04/2023', '02/28/2023', 99.36300834, 100, 3)).to.approximately(0.04227308289, 1e-11)
    // expect(financial.DISC('01/04/2023', '02/28/2023', 99.36300834, 100, 4)).to.approximately(0.04246611067, 1e-11)
    // expect(financial.DISC('01/04/2023', '03/30/2023', 99.00455556, 100, 0)).to.approximately(0.04166976726, 1e-11)
    expect(financial.DISC('01/04/2023', '03/30/2023', 99.00455556, 100, 1)).to.approximately(0.04274555536, 1e-11)
    expect(financial.DISC('01/04/2023', '03/30/2023', 99.00455556, 100, 2)).to.approximately(0.04215999981, 1e-11)
    expect(financial.DISC('01/04/2023', '03/30/2023', 99.00455556, 100, 3)).to.approximately(0.04274555536, 1e-11)
    // expect(financial.DISC('01/04/2023', '03/30/2023', 99.00455556, 100, 4)).to.approximately(0.04166976726, 1e-11)
    // expect(financial.DISC('01/04/2023', '06/29/2023', 97.78044445, 100, 0)).to.approximately(0.04565942846, 1e-11)
    expect(financial.DISC('01/04/2023', '06/29/2023', 97.78044445, 100, 1)).to.approximately(0.04603055544, 1e-11)
    expect(financial.DISC('01/04/2023', '06/29/2023', 97.78044445, 100, 2)).to.approximately(0.04539999989, 1e-11)
    expect(financial.DISC('01/04/2023', '06/29/2023', 97.78044445, 100, 3)).to.approximately(0.04603055544, 1e-11)
    // expect(financial.DISC('01/04/2023', '06/29/2023', 97.78044445, 100, 4)).to.approximately(0.04565942846, 1e-11)
    // expect(financial.DISC('01/04/2023', '10/5/2023', 96.73863889, 100, 0)).to.approximately(0.04332435423, 1e-11)
    expect(financial.DISC('01/04/2023', '10/5/2023', 96.73863889, 100, 1)).to.approximately(0.04344513887, 1e-11)
    expect(financial.DISC('01/04/2023', '10/5/2023', 96.73863889, 100, 2)).to.approximately(0.04284999999, 1e-11)
    expect(financial.DISC('01/04/2023', '10/5/2023', 96.73863889, 100, 3)).to.approximately(0.04344513887, 1e-11)
    // expect(financial.DISC('01/04/2023', '10/5/2023', 96.73863889, 100, 4)).to.approximately(0.04332435423, 1e-11)
