...
describe('Financial', () => {
  ...
  // TODO: implement
  it('DISC', () => {
    expect(financial.DISC).to.throw('DISC is not implemented')
  })
  ...
  it('PRICEDISC', () => {
    ...
    // expect(financial.PRICEDISC('01/05/2023', '02/28/2023', 0.0414, 100, 0)).to.approximately(99.3905, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '02/28/2023', 0.0414, 100, 1)).to.approximately(99.38750685, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '02/28/2023', 0.0414, 100, 2)).to.approximately(99.379, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '02/28/2023', 0.0414, 100, 3)).to.approximately(99.38750685, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '02/28/2023', 0.0414, 100, 4)).to.approximately(99.3905, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '04/06/2023', 0.0432, 100, 0)).to.approximately(98.908, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '04/06/2023', 0.0432, 100, 1)).to.approximately(98.9229589, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '04/06/2023', 0.0432, 100, 2)).to.approximately(98.908, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '04/06/2023', 0.0432, 100, 3)).to.approximately(98.9229589, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '04/06/2023', 0.0432, 100, 4)).to.approximately(98.908, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '07/06/2023', 0.04538, 100, 0)).to.approximately(97.71839444, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '07/06/2023', 0.04538, 100, 1)).to.approximately(97.73721644, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '07/06/2023', 0.04538, 100, 2)).to.approximately(97.70578889, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '07/06/2023', 0.04538, 100, 3)).to.approximately(97.73721644, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '07/06/2023', 0.04538, 100, 4)).to.approximately(97.71839444, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '10/05/2023', 0.0423, 100, 0)).to.approximately(96.8275, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '10/05/2023', 0.0423, 100, 1)).to.approximately(96.83619178, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '10/05/2023', 0.0423, 100, 2)).to.approximately(96.79225, 1e-8)
    expect(financial.PRICEDISC('01/05/2023', '10/05/2023', 0.0423, 100, 3)).to.approximately(96.83619178, 1e-8)
    // expect(financial.PRICEDISC('01/05/2023', '10/05/2023', 0.0423, 100, 4)).to.approximately(96.8275, 1e-8)
    ...
    expect(financial.PRICEDISC('01/05/2023', '01/31/2023', 0.038, 100, 4)).to.equal(error.num)
